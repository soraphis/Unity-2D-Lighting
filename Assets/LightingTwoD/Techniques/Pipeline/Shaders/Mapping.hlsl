...
#ifndef PIPELINE_MAP_INCLUDED
#define PIPELINE_MAP_INCLUDED
...
VertexOutput PassVertex(VertexInput input){
    ...
    // FIXME: seems to be always s = 0 
    // probably because the pipeline does not support vertex color!? maybe... need to investigate
